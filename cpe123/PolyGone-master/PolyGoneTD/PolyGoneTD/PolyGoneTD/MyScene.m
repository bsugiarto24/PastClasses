...
@property int count;
@property int adjuster;
@property int difficulty;
@property int towerTwoCount;
@end
(
...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        EnemyPath *end = [[EnemyPath alloc] initEnd];
        [self addChild:end];
...
- (SKNode*) addEnemy{
    ...
    SquareEnemy *enemy = [[SquareEnemy alloc] initWithDifficulty:self.player.difficulty inMap:1];
    [self addChild:enemy];
