...
/**
 *Shape abstract class to represent all 2d shapes for canvas
...
public abstract class Shape implements Comparable<Shape>{
    ...
    */
	...
	public Shape(Color col, boolean filled){
		c= col;
		fill = filled;
	}
	/**
   ...
   public Color getColor(){
	   Color r = new Color(c.getRed(),c.getGreen(),c.getBlue());
	   return r;
   }
   ...
   public boolean equals(Object o){
      ...
      !((Shape)o).getColor().equals(c)||
      !((Shape)o).getFilled()==fill)
	    	  return false;
	      return true;
   }
   ...
   public int compareTo(Shape o) {
		...
		}else if(Double.compare(getArea(), o.getArea())!=0){
