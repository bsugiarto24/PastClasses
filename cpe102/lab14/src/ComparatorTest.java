...
public class ComparatorTest {
	...
	public static void main(String[] args) {
        ...
        Comparator<Person> fl = new OrderFirst(new OrderLast());
	    Collections.sort(list5, fl);
        
        Comparator<Person> f = new OrderFirst();    
	    Comparator<Person> l = new OrderLast(f);
	    Collections.sort(list6, l);
	    
	    Comparator<Person> sl = new OrderState(new OrderLast());
	    Collections.sort(list7, sl);
	    
	    Comparator<Person> as = new OrderAge(new OrderState());
	    Collections.sort(list8, as);
