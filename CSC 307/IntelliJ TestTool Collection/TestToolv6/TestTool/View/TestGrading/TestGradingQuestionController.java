...
public class TestGradingQuestionController implements Initializable {
    ...
    private void goToFeedback(Question question) throws Exception {
        FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("View/TestGrading/FeedbackPopover.fxml"));
        loader.setControllerFactory((cf) -> {
            return new FeedbackPopoverController(mainApp, activeTest, studentTest, question, this);
        });
