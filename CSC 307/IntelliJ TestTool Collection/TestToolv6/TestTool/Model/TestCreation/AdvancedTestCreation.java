...
public class AdvancedTestCreation {
	...
	*/
	public void genAdvTest(String testName, int testLengthNum, String testLengthUnit, String course, ArrayList<AdvTestOption> advOpt) {
        ...
        /* Counts the questions add for each option. */
        int curOptCounter = 0;
        ...
        for (int i = 0; i < advTestOpt.size(); i++) {
            ...
            *  On the specified question limit.
            */
            for (int j = 0; j < instance.size(); j++) {
                ...
                /* If we already added the amount of questions specified, break out of the loop. */
                if (curOptCounter == advTestOpt.get(i).getNumberQuestions())
                    break;
            }
        }
