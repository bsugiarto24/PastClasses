...
public class QuestionEditorTopController {
	...
	public boolean showErrorMessage(String error) {
	    try {
	        ...
	        if (error.compareTo("Missing Info") == 0)
	        	loader.setLocation(MainApp.class.getResource("View/QuestionManagement/MissingInfo.fxml"));
	        else
	        	loader.setLocation(MainApp.class.getResource("View/QuestionManagement/OnlyRealNumbers.fxml"));
