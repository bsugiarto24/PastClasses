...
public class TestTaking {
	...
	public static boolean isFinished(ArrayList<Boolean> AnswerInTest) {
		if (AnswerInTest.size() != (StudentAssignedTests.get(StudentLogin.returnTestNum()).getQuestions().size())) {
			return false;
		}
		return true;
	}
