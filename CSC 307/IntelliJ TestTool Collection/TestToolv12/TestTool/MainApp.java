...
public class MainApp extends Application {
    ...
    public static HashMap<String, MenuItem> map = new HashMap<>();
	...
	private void initBanks(){
		...
		try
		{
            File a = new File("TestTool/Resources/questionBank.txt");
           ...
           fis = new FileInputStream("TestTool/Resources/users.txt");
            ois = new ObjectInputStream(fis);
    ...
    private void saveBanks(){
        ...
        try{
            ...
            fos= new FileOutputStream("TestTool/Resources/users.txt");
            oos= new ObjectOutputStream(fos);
