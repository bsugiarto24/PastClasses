...
public class CourseController implements Initializable {
    ...
    @FXML
    private Text couseName, addSubject, title;
    @FXML
    ...
    public void addSubjectToCourse(){
        ...
        if(subject.getText().equals("")) {
            ...
            a.setTitle("Success");
            a.setContentText("Successfully added Subject: " + sub.getName());
            a.showAndWait();
        }
    }
    ...
    public void addCourse(){
        ...
        if(isStudent) {
            ...
            if (name.getText().equals("")) {
                ...
                courses.add(add);
                add.addStudent((TestTaker) User.getUserLoggedIn());
    ...
    public void popup() {
            ...
            if(collect.getAllCourseList().size() != 0) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        title.setText(User.getUserLoggedIn().getName() + "'s Courses");
        delete.setVisible(false);
        collect = CourseCollection.getInstance();

        if(User.getUserLoggedIn().getClass().equals(TestTaker.class))
            isStudent = true;
