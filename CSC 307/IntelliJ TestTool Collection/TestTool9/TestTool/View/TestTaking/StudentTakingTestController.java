...
public class StudentTakingTestController {
    ...
    private void initialize() {
       ...
       /* ArrayList<Question>  questions = new ArrayList<>();
        ...
        choices.add("answer4");
        answer.add(1);
        Question q1 = new FreeResponse();
        Question q2 = new FillInTheBlank();
        q1.setQuestion("what");
        q2.setQuestion(("huh"));

        q1.setType("FreeResponse");
        q2.setType("FillInBlank");
        ...
        for (int i = 0; i < questions.size(); i++ ) {
            ...
            switch (questions.get(i).getType()) {
                case "True/False": TrueFalseBuild(QuestionVBox, QuestionScrollPane, SelectionTable, AnswerColumn, QuestionAnswersList, questions,FinishedSelectionQuestions, i);
                    break;
                case "Multiple Choice": MultipleChoiceBuild(QuestionVBox, QuestionScrollPane, SelectionTable, AnswerColumn, QuestionAnswersList, questions, FinishedSelectionQuestions, i);
                    break;
    ...
    public static void TrueFalseBuild(VBox QVBox, ScrollPane QSPane, ArrayList<TableView<String>> SelectionTable,
        ...
        SelectionTable.add(questionIndex,new TableView<>());
    ...
    public static void MultipleChoiceBuild(VBox QVBox, ScrollPane QSPane, ArrayList<TableView<String>> SelectionTable,
        ...
        SelectionTable.get(questionIndex).getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
        SelectionTable.add(questionIndex, new TableView<>());
