...
public class CourseCollection {
     ...
     * @param newC Course to add.
       ...
       pre:
        oldC != null && newC != null && !oldC.equals(newC) && courses.containsValue(oldC) &&
        newC.getName() != null && newC.getAccessCode() != null && newC.getSubjects() != null &&
        newC.getStudents() != null;
     ...
     * of the application.
     * @param course The HashMap that represents the persisted Courses.
     */
