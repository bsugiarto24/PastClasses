...
public class Question implements Serializable{
   ...
   *
   * @param t A String that matches to a question type to be set as the question's new type.
   * 
   * post: 
      //the Question type is set to be the new type
     this'.getType().equals(t);
   */
   ...
   * 
    ...
    this'.getQuestion().equals(question);
   */
   ...
   * post: 
    ...
    this'.getSubject().equals(subject);
   */
   ...
   */
    ...
    * 
    * @param score the QuestionScore object that score is to be set to
    * 
     post:
     this'.getScore().equals(score);
    */
