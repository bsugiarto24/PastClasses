...
public class LoginController implements Initializable {
    ...
    public void setMenuItems(HashMap<String, MenuItem> items){
    ...
    public void login() throws IOException{
        ...
        if(name.getText().equals("") || users.get(user) == null) {
            ...
            if(User.getUserLoggedIn() instanceof TestMaker) {
                menu.get("testGrading").setVisible(true);
                menu.get("testBank").setVisible(true);
                menu.get("questionCreation").setVisible(true);
                menu.get("testCreation").setVisible(true);
                menu.get("questionBank").setVisible(true);
            }

            else if(User.getUserLoggedIn() instanceof TestTaker) {
                menu.get("testGrading").setVisible(false);
                menu.get("testBank").setVisible(false);
                menu.get("questionCreation").setVisible(false);
                menu.get("testCreation").setVisible(false);
                menu.get("questionBank").setVisible(false);
            }
