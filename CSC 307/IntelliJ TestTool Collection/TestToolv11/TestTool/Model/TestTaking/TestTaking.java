...
public class TestTaking {
	...
	/*
	 * boolean to check if test taker have been updated
	 */
	...
	public static void setCreate(boolean boo){
		create = boo;
	}
	...
	public static void removeTest(int testNumber) {
		...
		for(int i = testNumber; i < StudentAssignedTests.size() - 1; i++) {
			StudentAssignedTests.set(i, StudentAssignedTests.get(i+1));
		}
	}
