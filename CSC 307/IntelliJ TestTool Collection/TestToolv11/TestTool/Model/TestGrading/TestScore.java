...
public class TestScore implements Serializable {
    ...
    /**
     * Increments the number of graded questions (gradedCount) by 1. This is incremented once per question in any
     * instance that a question's score is updated in any way.
     */
    ...
    /**
     * Utilizes getProgress to check if the test is 'complete'
     */
