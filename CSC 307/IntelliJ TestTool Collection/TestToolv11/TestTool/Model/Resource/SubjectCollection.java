...
public class SubjectCollection {
    ...
    /**
     * Returns all of the Subjects in a HashMap.
     * @return HashMap of the Subjects
     */
    ...
    /**
     * Sets the HashMap of Subjects.
     * @param newSubjects HashMap of new Subjects.
     */
    public void setSubjects(HashMap<String, Subject> newSubjects) {
    ...
    /**
     * Resets the collection of Subjects -- Used during testing to blow away collection and restart.
     */
    public void reset() {
        subjects = new HashMap<>();
    }
