...
public class RanTestController {
    ...
    public void basicHandleGen() {
        //BasicTestCreation.genBasicTest();
    }

    public void advHandleGen() { AdvancedTestCreation.genAdvTest();
    }
    ...
    public void backToRanMain() throws Exception {
        FXMLLoader load = new FXMLLoader();
        load.setLocation(MainApp.class.getResource("View/TestCreation/basicGen.fxml"));
        AnchorPane curPane = (AnchorPane) load.load();
        mainApp.rootLayout.setCenter(curPane);
        mainApp.primaryStage.show();
    }
